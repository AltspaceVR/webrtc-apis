...
namespace webrtc
{
  ...
  //-----------------------------------------------------------------------------
  rtc::scoped_refptr<AudioDeviceModule> AudioDeviceWasapi::create(const CreationProperties &info) noexcept {
  ...
  //-----------------------------------------------------------------------------
  int32_t AudioDeviceWasapi::RegisterAudioCallback(AudioTransport* audioCallback) {
  ...
  //-----------------------------------------------------------------------------
  rtc::scoped_refptr<AudioDeviceModule> IAudioDeviceWasapi::create(const CreationProperties &info) noexcept
  {
